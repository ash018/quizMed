...
<body>
    ...
    <?php $ans_array = array($questions[2]->choice1, $questions[2]->choice2, $questions[2]->choice3);
	shuffle($ans_array); ?>
	...
	<table >
				...
				<tr>
					...
					<td><h1 style="color:#FFFFFF"><?=$questions[2]->quizID?>.<?=$questions[2]->question?></h1> </td>
					
				</tr>
				<tr>
					
					<td><input  type="radio" name="quizid<?=$questions[2]->quizID?>" value="<?=$ans_array[0]?>" ></td> 
				...
				<tr>
					...
					<td><input  type="radio" name="quizid<?=$questions[2]->quizID?>" value="<?=$ans_array[1]?>"></td> 
				...
				<tr>
					...
					<td><input  type="radio" name="quizid<?=$questions[2]->quizID?>" value="<?=$ans_array[2]?>"></td> 
