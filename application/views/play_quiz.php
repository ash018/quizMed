...
<body>
    ...
    <?php $ans_array = array($questions[0]->choice1, $questions[0]->choice2, $questions[0]->choice3);
	shuffle($ans_array);
	//var_dump($questions);
	?>
	...
	<div class="form" style="color:#FFFFFF">
		...
		<table >
				...
				<tr>
					...
					<td><h1 style="color:#FFFFFF"><?=$questions[0]->quizID?>.<?=$questions[0]->question?></h1> </td>
					
				</tr>
				<tr>
					
					<td><input  type="radio" name="quizid<?=$questions[0]->quizID?>" value="<?=$ans_array[0]?>" ></td> 
				...
				<tr>
					...
					<td><input  type="radio" name="quizid<?=$questions[0]->quizID?>" value="<?=$ans_array[1]?>"></td> 
				...
				<tr>
					...
					<td><input  type="radio" name="quizid<?=$questions[0]->quizID?>" value="<?=$ans_array[2]?>"></td> 
